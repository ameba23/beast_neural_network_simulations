...
// AI23 Coursework 3 
// Greg Jones 
// Question 3d - (a) attractive chemotaxis only
...
public:
	EvoBacterium()
	{
		...
		// help...
		SetReproductionCost(0.5);	// default: 5.0
		...
		SetDeathThreshold(0.2);		// default: 0.0
		SetEnergy(0.5);			// default: 1.0
		...
		SetReproductionThreshold(5.0);	// default: 0.4
		SetConsumptionRate(0.2);		// default: 0.1
		SetSporulationThreshold(0.0);			// default: 0.25
		SetAttractantRate(0.0);		// default: 0.5
		SetRepellentRate(0.0);			// default: 4.0
...
//		SetGradientInfluence(randval(2.0));		// default: 0.8
		...
		SetAttractantThreshold(0.5);		// default: 0.5 (these 2 were commented before
		SetRepellentThreshold(0.5);		// default: 0.5
		
		SetNutrientResponse(0.8);		// default: 0.8
		SetAttractantResponse(0.0);		// default: 0.8
		// repellent turned off:
		SetRepellentResponse(0.0);		// default: 0.8
		
		// We set the speed to 0.0 here so that bacteria are non-motile.
		//SetMaxSpeed(0.0);
		//SetMinSpeed(0.0);
		SetSpeed(5.0);					// default: 40.0
...
//*/
		...
		This.SetTimeSteps(1500);	// default: 1000
