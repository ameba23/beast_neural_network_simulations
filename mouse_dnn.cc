...
// Mice with dynamical neural network instead of a feedforward network.
...
{
public:
	NeuralMouse(): myBrain(1, 2, 4, true, false) // four neurons in total
	{
...
private:
	DynamicalNet myBrain; // dynamical instead of feed forward
};
