...
// AI23 Coursework 3 
// Greg Jones 
// Question 4 - Evolve a functional chemotactic response
...
public:
	EvoBacterium()
	{
		...
		// Start these at random since we want to evolve them
		SetReproductionThreshold(randval(10.0));	// default: 0.4 i had 5.0
		SetConsumptionRate(randval(0.2));		// default: 0.1 i had 0.2
...
//		float numAlive = numTotal - numDead;
		...
		// My chosen fitness function:
		return totalEnergy / numTotal;
		//return numAlive;
		// return numTotal;
