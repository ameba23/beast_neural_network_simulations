...
// Mice with dynamical network with 6 neurons and both proximity and angle sensors.
// Greg Jones 15/3/04
...
{
public:
	NeuralMouse(): myBrain(2, 2, 6, true, false) // 6 neurons in total
	{
	...
	virtual void Control()
	{
		...
		This.myBrain.SetInput(1, This.Sensors["proximity"]->GetOutput());
...
private:
	DynamicalNet myBrain; // dynamical network instead of feed forward
};
...
public:
	...
	{
// both angle and proximity sensors:
		This.Add("angle", NearestAngleSensor<Cheese>());
