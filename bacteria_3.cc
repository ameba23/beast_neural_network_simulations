...
// AI23 Coursework 3 
// Greg Jones 
// Question 3d - both attractant and repellent turned on. (Equal response)
...
public:
	EvoBacterium()
	{
		...
		SetAttractantRate(0.5);		// default: 0.5
		SetRepellentRate(0.5);			// default: 4.0
...
//		SetGradientInfluence(randval(2.0));		// default: 0.8
        	...
        	SetAttractantThreshold(0.9);		// default: 0.5 
		SetRepellentThreshold(0.5);		// default: 0.5
	
		// Equal response to attractants and repellents:	
		SetNutrientResponse(1.0);		// default: 0.8
		SetAttractantResponse(1.0);		// default: 0.8
		SetRepellentResponse(1.0);		// default: 0.8
