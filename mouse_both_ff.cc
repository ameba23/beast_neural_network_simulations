...
{
public:
	NeuralMouse(): myBrain(2, 2, 4, false) //2 inputs
	{
		...
		ffnConfig.push_back( 1.0f); // 3rd hidden 1st weight (for input 1)
		ffnConfig.push_back( 0.0f); // 3rd hidden 2nd weight (for input 2)
		ffnConfig.push_back(-0.5f); // 3rd hidden bias

		ffnConfig.push_back( 1.0f); // 4th hidden 1st weight (for input 1)
		ffnConfig.push_back( 0.0f); // 4th hidden 2nd weight (for input 2)
		ffnConfig.push_back(-0.5f); // 4th hidden bias
