...
// AI23 Coursework 3 
// Greg Jones 
// Question 3b - chemotaxis and with motility turned on.
...
public:
	EvoBacterium()
	{
		...
		SetRepellentRate(4.0);			// default: 4.0
...
//		SetGradientInfluence(randval(2.0));		// default: 0.8
		...
		SetAttractantThreshold(0.5);		// default: 0.5 
		SetRepellentThreshold(0.5);		// default: 0.5
		
		SetNutrientResponse(0.8);		// default: 0.8
		SetAttractantResponse(0.8);		// default: 0.8
		SetRepellentResponse(0.8);		// default: 0.8
